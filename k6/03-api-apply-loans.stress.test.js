...
export const options = {
  stages: [
    ...
    { duration: '2m', target: 50 },   // Increase to 50 VUs over 3 minutes
    { duration: '4m', target: 100 },  // Increase to 100 VUs over 5 minutes
    { duration: '2m', target: 300 },  // Stay at 300 VUs for 2 minutes
...
http_req_duration: ['p(95)<500', 'p(99)<1000'],  // 95% of requests under 500ms, 99% under 1s
  ...
  // Setting high concurrent users for stress testing
  // This simulates a heavy load that exceeds normal conditions
  // to evaluate system behavior under stress and identify
