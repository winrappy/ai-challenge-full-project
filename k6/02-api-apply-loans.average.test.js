...
export const options = {
  stages: [
    ...
    { duration: '3m', target: 50 },   // Increase to 50 VUs over 3 minutes
  ...
  // Setting 10 concurrent users for average test load
  // This simulates a moderate load that should be sufficient
  // to evaluate system behavior under normal conditions
